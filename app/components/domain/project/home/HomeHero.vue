...
// Port de src/components/project/home/HomeHero.tsx (Next). A diferencia del
// original (server component que llama a getSlides() directo), aquí se
// consume vía server/api/slides/index.get.ts (Nitro) — services/** es
