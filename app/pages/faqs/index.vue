...
// Reusa el mismo endpoint /api/faqs que ya
...
// porta — ver .project_docs/routes.md) ni NoContent.vue (aquí se sigue el
// mismo patrón ya establecido por app/pages/news/index.vue: un <p> con
// main.no_results).
const { t } = useI18n()
